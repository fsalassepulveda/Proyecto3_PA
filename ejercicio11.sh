...
echo -e "#!/bin/bash \n
wget -r -A .csv -nd  https://srvbioinf1.utalca.cl/~fduran/data" > Lista.txt
...
for i in `seq 1 12`;do
	...
	cat humedad_2011.txt |awk '$1=='$i' {prom+=$2; sum+=1} ;END {print '$i' ";" prom/sum}'  >> humedad1_2011.csv
	cat humedad_2012.txt |awk '$1=='$i' {prom+=$2; sum+=1} ;END {print '$i'  ";" prom/sum}' >> humedad1_2012.csv
	cat humedad_2013.txt |awk '$1=='$i' {prom+=$2; sum+=1} ;END {print '$i'  ";" prom/sum}' >> humedad1_2013.csv
	cat humedad_2014.txt |awk '$1=='$i' {prom+=$2; sum+=1} ;END {print '$i'  ";" prom/sum}' >> humedad1_2014.csv
	...
	cat temperatura_2011.txt |awk '$1=='$i' {prom+=$2; sum+=1} ;END {print '$i'  ";" prom/sum}' >> temperatura1_2011.csv
	cat temperatura_2012.txt |awk '$1=='$i' {prom+=$2; sum+=1} ;END {print '$i'  ";" prom/sum}' >> temperatura1_2012.csv
	cat temperatura_2013.txt |awk '$1=='$i' {prom+=$2; sum+=1} ;END {print '$i'  ";" prom/sum}' >> temperatura1_2013.csv
	cat temperatura_2014.txt |awk '$1=='$i' {prom+=$2; sum+=1} ;END {print '$i'  ";" prom/sum}' >> temperatura1_2014.csv
